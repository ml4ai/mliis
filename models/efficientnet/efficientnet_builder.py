# Modified Copyright 2020 Sean M. Hendryx. All Rights Reserved.
...
class BlockDecoder(object):
  ...
  def decode(self, string_list, max_block_num=None):
...
def get_model_params(model_name, override_params, max_block_num=None):
...
def build_model_base(images, model_name, training, override_params=None, max_block_num=None):
